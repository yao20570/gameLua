...
HeroBluePanel = class("HeroBluePanel", BasicPanel)
HeroBluePanel.NAME = "HeroBluePanel"

local COLOR = 3

function HeroBluePanel:ctor(view, panelName)
    HeroBluePanel.super.ctor(self, view, panelName)
    
    self:setUseNewPanelBg(true)
end

function HeroBluePanel:finalize()
    ...
    HeroBluePanel.super.finalize(self)
end

function HeroBluePanel:initPanel()
    HeroBluePanel.super.initPanel(self)
...
function HeroBluePanel:doLayout()
...
function HeroBluePanel:onShowHandler()
...
function HeroBluePanel:moveCallback(centerIdx)
...
function HeroBluePanel:dirBtnTouch(sender)
	local mainPanel = self:getPanel(HeroPokedexPanel.NAME)
	mainPanel:dirBtnTouch(sender.dir, self)
end

function HeroBluePanel:getAllItems()
	return self._allItem
end

-- 类型  1-兵营 2-武将 3-太学院 4-战法 5-军师 
function HeroBluePanel:onCommentBtn(sender)
	local mainPanel = self:getPanel(HeroPokedexPanel.NAME)
