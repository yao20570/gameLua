...
HeroVioletPanel = class("HeroVioletPanel", BasicPanel)
HeroVioletPanel.NAME = "HeroVioletPanel"

local COLOR = 4

function HeroVioletPanel:ctor(view, panelName)
    HeroVioletPanel.super.ctor(self, view, panelName)
    
    self:setUseNewPanelBg(true)
end

function HeroVioletPanel:finalize()
    ...
    HeroVioletPanel.super.finalize(self)
end

function HeroVioletPanel:initPanel()
    HeroVioletPanel.super.initPanel(self)
...
function HeroVioletPanel:doLayout()
...
function HeroVioletPanel:onShowHandler()
...
function HeroVioletPanel:moveCallback(centerIdx)
...
function HeroVioletPanel:dirBtnTouch(sender)
	local mainPanel = self:getPanel(HeroPokedexPanel.NAME)
	mainPanel:dirBtnTouch(sender.dir, self)
end

function HeroVioletPanel:getAllItems()
	return self._allItem
end

-- 类型  1-兵营 2-武将 3-太学院 4-战法 5-军师 
function HeroVioletPanel:onCommentBtn(sender)
	local mainPanel = self:getPanel(HeroPokedexPanel.NAME)
