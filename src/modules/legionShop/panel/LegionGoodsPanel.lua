...
LegionGoodsPanel = class("LegionGoodsPanel", BasicPanel)
LegionGoodsPanel.NAME = "LegionGoodsPanel"

function LegionGoodsPanel:ctor(view, panelName)
    LegionGoodsPanel.super.ctor(self, view, panelName)
    
    self:setUseNewPanelBg(true)
end

function LegionGoodsPanel:finalize()
    LegionGoodsPanel.super.finalize(self)
end

function LegionGoodsPanel:initPanel()
	LegionGoodsPanel.super.initPanel(self)
...
function LegionGoodsPanel:onAfterActionHandler()
	self:onShowHandler()
end

function LegionGoodsPanel:onUpdatePanel()
...
function LegionGoodsPanel:updateMyContribute()
	local legionProxy = self:getProxy(GameProxys.Legion)
	local info,contribute,legionlv  = legionProxy:getShopList(1)
...
function LegionGoodsPanel:renderItemPanel(item,itemInfo,index)
...
function LegionGoodsPanel:touchExchangeBtn(sender)
